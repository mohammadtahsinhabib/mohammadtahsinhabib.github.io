...
Legacy is an easy Windows machine vulnerabl tesing modification e to MS17-010 (EternalBlue). Simple exploitation path with no privilege escalation required.
